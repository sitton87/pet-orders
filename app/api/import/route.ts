...
export async function GET(request: NextRequest) {
  try {
    ...
    if (type === "suppliers") {
      // תבנית ספקים
      const instructions = [
        "הוראות: מלא את השורות החל מהשורה הרביעית. שדות חובה: שם הספק, מדינה. מחק את שורת הדוגמה לפני הייבוא",
      ];
      ...
      // תבנית הזמנות
      const instructions = [
        "הוראות: מלא את השורות החל מהשורה הרביעית. שדות חובה: מספר הזמנה, שם ספק. מחק את שורת הדוגמה לפני הייבוא",
      ];
      ...
      // תבנית קטגוריות
      const instructions = [
        "הוראות: מלא את השורות החל מהשורה הרביעית. שדות חובה: שם קטגוריה. מחק את שורת הדוגמה לפני הייבוא",
      ];
